...
/**
 * Displays and logs letter grade into new txt file provided by user.
 * @param grades, array provided from file inputed by user.
 */
	...
	/**
	 * Returns grades array back to main to be used for another method after
	 * displaying average total in the provided array.
	 * 
	 * @param grades
	 */
